...
<body>
    <div class="container">
        <div class="row">
            <div class="col">
                <a href="index.php" style="color: rgb(255, 255, 255);text-decoration: none;padding: 10px 20px;background-color: #15172b;border-radius: 10px;font-weight: 600;border: 3px solid #15172b;"> WIDE-X</a>
            </div>
        </div>
        <div class="row" style="justify-content: center;">
            ...
            <form action="<?php $_SERVER['PHP_SELF']?>" method="POST" id="pform">
                <div class="form">
                    ...
                    <div class="subtitle">Let's goto WIDE-X!</div>
