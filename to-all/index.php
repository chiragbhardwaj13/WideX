...
<body>
    ...
    <div id="home" class="banner">
            <div class="hero-title-wrapper">
                <h1 class="hero-heading">Welcome to WIDE-X</h1>
        ...
        <div class="gallery" id="img">
          <div class="section-title-group">
              ...
              <div class="section-subheading center">Glimpse of our WIDE-X</div>
          </div>
        ...
        <footer class="footer center">
            <div class="w-container">
                <div class="footer-text">Copyright WIDE-X</div>
            </div>
        </footer>
    </div>
